...
public class LoginController {
	...
	public User validateUserLogin(@RequestBody User user) {		
		...
		User user1 = new User("navinneriya07@gmail.com", "123456");
		User user2 = new User("navin@gmail.com", "123456");
		
		Role role1=new Role("ADMIN");
		Role role2=new Role("USER");
		
		roleRepository.saveAll(new HashSet<Role>()
		{
			{
				add(new Role("ADMIN", new HashSet<User>()
				{
					{
						add(user1);
					}
				...
				add(new Role("USER", new HashSet<User>()
				{
					{
						add(user1);
						add(user2);
		...
		userRepository.saveAll(new HashSet<User>()
		{
			{
				add(new User("navinneriya07@gmail.com","123456", new HashSet<Role>()
				{
					{
						add(role1);
						add(role2);
				...
				add(new User("navin@gmail.com","123456", new HashSet<Role>()
				{
					{
						add(role2);
					}
